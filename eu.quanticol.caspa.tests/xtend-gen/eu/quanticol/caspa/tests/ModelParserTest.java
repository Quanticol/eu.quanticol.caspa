...
public class ModelParserTest {
  ...
  public void testSimple() {
    try {
      ...
      _builder.newLine();
      _builder.append("P=[True]Q;");
      _builder.newLine();
      _builder.append("Q=[True]P;");
      _builder.newLine();
  ...
  public void testSimplePar() {
    try {
      ...
      _builder.newLine();
      _builder.append("A = [True]B;");
      _builder.newLine();
      _builder.append("B = [False]A;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionUniOut() {
    try {
      ...
      _builder.newLine();
      _builder.append("P = a[True]<>.P;");
      _builder.newLine();
      _builder.append("Q = a[True]().Q;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionUniIn() {
    try {
      ...
      _builder.append("(P,{a:=1});");
      _builder.newLine();
      _builder.append("P = a[False]().Q;");
      _builder.newLine();
      _builder.append("Q = a[False]<>.P;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionUniOutU() {
    try {
      ...
      _builder.append("(Q,{a:=1});");
      _builder.newLine();
      _builder.append("P = a[True]<>{this.a := 1}.P;");
      _builder.newLine();
      _builder.append("Q = a[True](){this.a := 1}.Q;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionUniInU() {
    try {
      ...
      _builder.newLine();
      _builder.append("Q = a[False]<>{this.a := 1}.Q;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleCho2() {
    try {
      ...
      _builder.append("P = A + B;");
      _builder.newLine();
      _builder.append("A = [True]A;");
      _builder.newLine();
      _builder.append("B = [True]B;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionBroOutU2() {
    try {
      ...
      _builder.append("(Q,{a:=1, b:=1});");
      _builder.newLine();
      _builder.append("P = a*[True]<>{a := 1}.P;");
      _builder.newLine();
      _builder.append("Q = a*[True](){a := 1}.Q;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testSimpleActionUniInU3() {
    try {
      ...
      _builder.append("P = a[False](){a := 1}.P;");
      _builder.newLine();
      _builder.append("Q = a[False]<>{a := 1}.Q;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testProcessPredicate() {
    try {
      ...
      _builder.append(" ");
      _builder.newLine();
      _builder.append("Z = [True]X;");
      _builder.newLine();
      _builder.append("X = [True]Z;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
  ...
  public void testTermStore() {
    try {
      ...
      _builder.newLine();
      _builder.append("(P,{b:=1}); \t\t// (@CDW VALIDATIONCHECK:This is a TERM repetition. \t27.01.15)");
      _builder.newLine();
      _builder.append("(P,{a:=1,c:=1});");
      _builder.newLine();
  ...
  public void testTermProcess() {
    try {
      ...
      _builder.append("P = [True]Q;");
      _builder.newLine();
      _builder.append("Q = [True]R;");
      _builder.newLine();
      _builder.append("R = [True]S;");
      _builder.newLine();
      _builder.append("S = [True]P;");
      _builder.newLine();
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("H = a[True]<>.H;");
      _builder.newLine();
      _builder.newLine();
      _builder.append("//UNUSED");
      _builder.newLine();
      _builder.append("I = [True]J;\t//(@CDW VALIDATIONCHECK 27.01.15 - this goes unused, need a check for this?)");
      _builder.newLine();
      _builder.newLine();
      _builder.append("J = a[True]().J;");
      _builder.newLine();
      Model _parse = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertNoErrors(_parse);
    } catch (Throwable _e) {
