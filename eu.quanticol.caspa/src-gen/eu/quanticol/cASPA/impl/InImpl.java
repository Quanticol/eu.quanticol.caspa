 ...
 * <ul>
 *   <li>{@link eu.quanticol.cASPA.impl.InImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InImpl extends ArgumentsImpl implements In
{
  ...
  {
    return CASPAPackage.Literals.IN;
  }
  ...
  public EList<Arguments> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<Arguments>(Arguments.class, this, CASPAPackage.IN__EXPRESSIONS);
    }
    return expressions;
  }
