 ...
 * <ul>
 *   <li>{@link eu.quanticol.cASPA.impl.GlobalEvaluationExpressionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalEvaluationExpressionImpl extends EvaluationExpressionInImpl implements GlobalEvaluationExpression
{
  ...
  {
    return CASPAPackage.Literals.GLOBAL_EVALUATION_EXPRESSION;
  }
    ...
    if (name != null && name.eIsProxy())
    {
      ...
      if (name != oldName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CASPAPackage.GLOBAL_EVALUATION_EXPRESSION__NAME, oldName, name));
      }
    }
    return name;
  }
  ...
  public void setName(Store newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CASPAPackage.GLOBAL_EVALUATION_EXPRESSION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CASPAPackage.GLOBAL_EVALUATION_EXPRESSION__NAME:
