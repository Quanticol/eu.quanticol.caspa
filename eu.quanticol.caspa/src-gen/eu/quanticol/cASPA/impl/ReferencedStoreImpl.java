 ...
 * @generated
 */
public class ReferencedStoreImpl extends ActionExpressionImpl implements ReferencedStore
{
  /**
    ...
    if (value != null && value.eIsProxy())
    {
      ...
      if (value != oldValue)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, CASPAPackage.REFERENCED_STORE__VALUE, oldValue, value));
      }
    }
    return value;
  }
