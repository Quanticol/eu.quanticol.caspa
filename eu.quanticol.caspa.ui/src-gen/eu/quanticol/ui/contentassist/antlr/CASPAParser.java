		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionExpressionAccess().getAlternatives(), "rule__FunctionExpression__Alternatives");
					...
					put(grammarAccess.getUpdateExpressionAccess().getGroup_0_2(), "rule__UpdateExpression__Group_0_2__0");
					put(grammarAccess.getUpdateExpressionAccess().getGroup_0_3(), "rule__UpdateExpression__Group_0_3__0");
					put(grammarAccess.getSelfReferencedStoreAccess().getGroup(), "rule__SelfReferencedStore__Group__0");
					put(grammarAccess.getFunctionExpressionAccess().getGroup_0(), "rule__FunctionExpression__Group_0__0");
					put(grammarAccess.getFunctionExpressionAccess().getGroup_1(), "rule__FunctionExpression__Group_1__0");
					...
					put(grammarAccess.getUpdateExpressionAccess().getNameAssignment_0_2_1(), "rule__UpdateExpression__NameAssignment_0_2_1");
					put(grammarAccess.getUpdateExpressionAccess().getExpressionAssignment_0_2_3(), "rule__UpdateExpression__ExpressionAssignment_0_2_3");
					put(grammarAccess.getUpdateExpressionAccess().getNameAssignment_0_3_1(), "rule__UpdateExpression__NameAssignment_0_3_1");
					put(grammarAccess.getUpdateExpressionAccess().getExpressionAssignment_0_3_3(), "rule__UpdateExpression__ExpressionAssignment_0_3_3");
					put(grammarAccess.getSelfReferencedStoreAccess().getNameAssignment_2(), "rule__SelfReferencedStore__NameAssignment_2");
					put(grammarAccess.getFunctionExpressionAccess().getDistributionAssignment_0_3(), "rule__FunctionExpression__DistributionAssignment_0_3");
					put(grammarAccess.getFunctionExpressionAccess().getDistributionAssignment_1_3(), "rule__FunctionExpression__DistributionAssignment_1_3");
					put(grammarAccess.getDistributionAccess().getProbAssignment_0(), "rule__Distribution__ProbAssignment_0");
					put(grammarAccess.getDistributionAccess().getExpressionAssignment_2(), "rule__Distribution__ExpressionAssignment_2");
					put(grammarAccess.getUniformAccess().getExpressionAssignment_0(), "rule__Uniform__ExpressionAssignment_0");
